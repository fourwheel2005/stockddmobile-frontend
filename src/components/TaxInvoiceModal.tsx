      ...
      <div role="dialog" aria-modal="true"
        ...
        <div className="space-y-3 p-5">
          <div className="rounded-md border border-amber-200 bg-amber-50 p-2.5 text-xs text-amber-800">
            {alreadyIssued
              ? <>ใบกำกับ <strong>{issuedNo}</strong> ออกแล้ว — การพิมพ์ครั้งถัดไปจะระบุเป็นสำเนาเมื่อมีต้นฉบับพิมพ์สำเร็จ</>
              : <>⚠️ ออกได้ <strong>บิลละ 1 ใบ</strong> และแก้ไขไม่ได้หลังออก · VAT ถอดใน 7/107 โดยไม่บวกยอดเพิ่ม</>}
          </div>
        ...
        <div className="flex justify-end gap-2 border-t px-5 py-3">
          ...
          <button className="btn-primary inline-flex items-center gap-1.5"
            ...
            {busy ? 'กำลังดำเนินการ...' : alreadyIssued ? 'พิมพ์ใบกำกับ' : 'ออกใบกำกับ + พิมพ์'}
          </button>
        </div>
      </div>
    </div>,
