...
/**
 * รอลงสต็อก — เครื่องใหม่ที่ตีเทิร์นเข้ามาจะพักที่นี่ (status PENDING_INTAKE) ยังไม่นับสต็อก/ขายไม่ได้
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500">
          เครื่องใหม่ที่รับเทิร์นเข้ามา — <strong>ยังไม่นับสต็อก / ขายไม่ได้</strong> · แก้ข้อมูล + เพิ่มรูปให้ครบ
